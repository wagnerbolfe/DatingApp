        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupMessageName = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Connections", x => x.ConnectionId);
                    table.ForeignKey(
                        name: "FK_Connections_Groups_GroupMessageName",
                        column: x => x.GroupMessageName,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Connections_GroupMessageName",
                table: "Connections",
                column: "GroupMessageName");
